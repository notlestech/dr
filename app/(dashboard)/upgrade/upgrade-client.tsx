...
const PLANS = [
  {
    ...
    features: ['1 form', '500 entries per form', '3 fields per form', '1 draw per form', '4 form templates', 'DrawVault branding'],
    cta: 'Current Plan',
    popular: false,
    icon: null,
    accent: '',
  },
  {
    ...
    features: ['Unlimited forms', '10,000 entries per form', '10 fields per form', 'Unlimited draws', 'All 15 templates', '7 draw themes', 'No branding', 'Analytics + CSV export'],
    cta: 'Upgrade to Pro',
    popular: true,
    icon: Zap,
  ...
  },
  {
    ...
    features: ['Everything in Pro', 'Unlimited entries', '3 workspaces', 'All 9 draw themes', 'Auto-draw scheduling', 'Webhooks', 'Audit logs', 'Priority support'],
